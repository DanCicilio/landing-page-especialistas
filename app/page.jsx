      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600 mb-6">Entre em contato conosco através de um desses canais:</p>
            ...
            <button onClick={() => setIsOpen(false)} className="w-full mt-6 bg-gray-200 text-dark py-3 rounded-lg font-bold hover:bg-gray-300 transition">Fechar</button>
          </div>
        </div>
      )}
    </>
